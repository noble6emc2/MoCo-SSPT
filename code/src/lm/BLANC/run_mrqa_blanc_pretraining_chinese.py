...
from pytorch_pretrained_bert.dataset_processor import CMRCProcessor
from pytorch_pretrained_bert.evaluation import MRQAEvaluator
...
def main(args):
    ...
    if args.do_eval and (args.do_train or (not args.eval_test)):
        raise NotImplementedError("This branch should not be accessed")
